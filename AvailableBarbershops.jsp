										...
										<ul class="combine-cont">
											...
											<li class="comb-item">
												<ul class="barber-btn-container">
													<li $activetabbook class="btn-item">
														<a class="btn btn-success" type="submit" style="color:white;" href="<%=request.getContextPath() %>/ismgroup26/BarbershopPage.jsp?bid=<%=buser.getBID()%>&active=book">Make reservation</a>
														</li>
													<li $activetabinfo class="btn-item">
														<a class="btn btn-info" type="submit" style="color:white;" href="<%=request.getContextPath() %>/ismgroup26/BarbershopPage.jsp?bid=<%=buser.getBID()%>&active=info">More information</a>
													</li>
													<li $activetabreview class="btn-item">
														<a class="btn btn-warning" type="submit" style="color:white;" href="<%=request.getContextPath() %>/ismgroup26/BarbershopPage.jsp?bid=<%=buser.getBID()%>&active=reviews">Review the barber</a>
													</li>
												</ul>
											</li>
										</ul>
